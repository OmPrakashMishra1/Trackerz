      ...
      html: `
        ...
        <html>
          ...
          <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: #ffffff; padding: 30px; border: 1px solid #ede9fe; border-top: none; border-radius: 0 0 10px 10px;">
              
              ${
                product.image_url
                  ? `
                <div style="text-align: center; margin-bottom: 20px;">
                  <img src="${product.image_url}" alt="${product.name}" style="max-width: 200px; height: auto; border-radius: 8px; border: 1px solid #ede9fe;">
                </div>
              `
                  : ""
              }
              
              <h2 style="color: #2c0653; margin-top: 0;">${product.name}</h2>
              
              <div style="background: #f5f3ff; border-left: 4px solid #7C3AED; padding: 15px; margin: 20px 0; border-radius: 4px;">
              ...
              <table style="width: 100%; margin: 20px 0;">
                <tr>
                  <td style="padding: 10px; background: #fbf7ff; border-radius: 4px;">
                ...
                <tr>
                  <td style="padding: 10px;">
                    ...
                    <div style="font-size: 32px; color: #7C3AED; font-weight: bold;">
              ...
              <div style="text-align: center; margin: 30px 0;">
                 <a href="${product.url}" 
                   style="display: inline-block; background: #7C3AED; color: white; padding: 14px 30px; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 16px;">
                  View Product →
                </a>
              </div>
              
              <div style="border-top: 1px solid #ede9fe; padding-top: 20px; margin-top: 20px; text-align: center; color: #6b7280; font-size: 12px;">
